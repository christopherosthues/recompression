...
int main(int argc, char *argv[]) {
    if (argc < 6) {
        std::cerr << "./recompression_all_bench [path] [file_name(s)] [parallel | parallel_lock | parallel_ls | parallel_gr | parallel_lp | fast | hash | parallel_rnd | full_parallel] [cores] [repeats] [prefix]" << std::endl;
        return -1;
    }
