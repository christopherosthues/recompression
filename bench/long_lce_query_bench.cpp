...
int main(int argc, char *argv[]) {
    if (argc < 8) {
        std::cerr << "./bench_long_lce_query [path] [file_name(s)] [recomp (parallel_lp) | naive | prezza | rmq] [repeats] [begin] [end] [step] [coder (fixed | plain | sorted)] [rlslp_path] [prefix]" << std::endl;
        return -1;
    }
