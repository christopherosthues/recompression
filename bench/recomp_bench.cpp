...
//    google::InitGoogleLogging(argv[0]);
    ...
    std::cout << "Time for sequential recompression: " << std::chrono::duration_cast<std::chrono::seconds>(timeSpan).count() << "[s]" << std::endl;
    std::cout << "Time for sequential recompression: " << std::chrono::duration_cast<std::chrono::milliseconds>(timeSpan).count() << "[ms]" << std::endl;
