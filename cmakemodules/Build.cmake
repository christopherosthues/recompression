...
#    add_dependency(${PROJECT_NAME} "sparsepp" REQUIRED)
...
#        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -ansi -ldl")
    ...
    if(${name} MATCHES "lce_query")
        message(STATUS "Adding libs for lce query benchmarks")
        add_dependency(bench_${name} "SDSL" REQUIRED)
    endif(${name} MATCHES "lce_query")

#    add_dependency(bench_${name} "prezzalce" REQUIRED)
