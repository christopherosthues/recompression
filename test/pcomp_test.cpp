...
TEST(parallel_order_pcomp, 212181623541741623541321) {
    ...
    par_text_t exp_text{10, 10, 12, 6, 9, 5, 11, 7, 11, 6, 9, 5, 11, 3, 10};
...
TEST(parallel_order_pcomp, 131261051171161051139) {
    // TODO
    par_text_t text{13, 12, 6, 9, 5, 11, 7, 11, 6, 9, 5, 11, 3, 10};
    rlslp<var_t, term_t> rlslp;
    parallel::recompression<var_t, term_t> recomp;
    rlslp.terminals = 5;
    rlslp.non_terminals.emplace_back(1, 2, 2);
...
TEST(parallel_order_pcomp, 18161517161514) {
    // TODO
...
TEST(parallel_order_pcomp, 21201619) {
    // TODO
...
TEST(parallel_order_pcomp, 2322) {
    // TODO
