...
TEST(fast_pcomp, 212181623541741623541321) {
    ...
    fast_text_t exp_text{4, 4, 7, 2, 5, 1, 6, 3, 6, 2, 5, 1, 6, 0, 4};
    std::vector<var_t> exp_mapping = {3, 5, 6, 7, 9, 10, 11, 12};
...
//    text_t text{13, 12, 6, 10, 5, 11, 7, 11, 6, 10, 5, 11, 3, 9};
    ...
    fast_text_t exp_text{4, 2, 1, 3, 2, 1, 0};
    std::vector<var_t> exp_mapping = {14, 15, 16, 17, 18};
...
TEST(fast_pcomp, 18161517161514) {
    ...
    fast_text_t exp_text{3, 2, 0, 1};
    std::vector<var_t> exp_mapping = {16, 19, 20, 21};
...
//    text_t text{21, 20, 16, 19};
    ...
    text_t exp_text{1, 0};
    std::vector<var_t> exp_mapping = {22, 23};
