...
typedef hash_recompression<var_t, term_t>::text_t text_t;
typedef hash_recompression<var_t, term_t>::adj_list_t adj_list_t;
typedef hash_recompression<var_t, term_t>::partition_t partition_t;
typedef hash_recompression<var_t, term_t>::alphabet_t alphabet_t;
typedef hash_recompression<var_t, term_t>::bv_t bv_t;
...
TEST(bcomp_hash, 21214441332311413334133231141321) {
    ...
    exp_rlslp.root = 0;
    exp_rlslp.resize(4);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{4, 3, 3};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{3, 2, 2};
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{1, 2, 2};
    exp_rlslp.non_terminals[3] = non_terminal<var_t, term_t>{3, 3, 3};
    exp_rlslp.blocks = 4;
...
TEST(bcomp_hash, 22222222211111112222) {
    ...
    exp_rlslp.root = 0;
    exp_rlslp.resize(3);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{2, 9, 9};
...
TEST(pcomp_hash, 212151623741841623741321) {
    ...
    rlslp.terminals = 5;
    rlslp.resize(4);
    rlslp.non_terminals[0] = non_terminal<var_t, term_t>{4, 3, 3};
    rlslp.non_terminals[1] = non_terminal<var_t, term_t>{3, 2, 2};
    rlslp.non_terminals[2] = non_terminal<var_t, term_t>{1, 2, 2};
    rlslp.non_terminals[3] = non_terminal<var_t, term_t>{3, 3, 3};
    rlslp.blocks = 4;
    ...
    exp_rlslp.non_terminals[5] = non_terminal<var_t, term_t>{5, 1, 4};
    exp_rlslp.non_terminals[6] = non_terminal<var_t, term_t>{2, 3, 2};
    exp_rlslp.non_terminals[7] = non_terminal<var_t, term_t>{4, 1, 2};
    exp_rlslp.blocks = 4;
...
TEST(pcomp_hash, 131061171281261171239) {
    ...
    rlslp.non_terminals[5] = non_terminal<var_t, term_t>{5, 1, 4};
    rlslp.non_terminals[6] = non_terminal<var_t, term_t>{2, 3, 2};
    rlslp.non_terminals[7] = non_terminal<var_t, term_t>{4, 1, 2};
    ...
    exp_rlslp.non_terminals[9] = non_terminal<var_t, term_t>{13, 10, 8};
    exp_rlslp.non_terminals[10] = non_terminal<var_t, term_t>{6, 11, 4};
    exp_rlslp.non_terminals[11] = non_terminal<var_t, term_t>{7, 12, 4};
    exp_rlslp.non_terminals[12] = non_terminal<var_t, term_t>{8, 12, 5};
    exp_rlslp.non_terminals[13] = non_terminal<var_t, term_t>{3, 9, 3};
    exp_rlslp.blocks = 5;
...
TEST(pcomp_hash, 14151617151618) {
    ...
    rlslp.non_terminals[7] = non_terminal<var_t, term_t>{4, 1, 2};
    rlslp.non_terminals[8] = non_terminal<var_t, term_t>{9, 2, 4};
    rlslp.non_terminals[9] = non_terminal<var_t, term_t>{13, 10, 8};
    rlslp.non_terminals[10] = non_terminal<var_t, term_t>{6, 11, 4};
    rlslp.non_terminals[11] = non_terminal<var_t, term_t>{7, 12, 4};
    rlslp.non_terminals[12] = non_terminal<var_t, term_t>{8, 12, 5};
    rlslp.non_terminals[13] = non_terminal<var_t, term_t>{3, 9, 3};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[12] = non_terminal<var_t, term_t>{8, 12, 5};
    exp_rlslp.non_terminals[13] = non_terminal<var_t, term_t>{3, 9, 3};
    exp_rlslp.non_terminals[14] = non_terminal<var_t, term_t>{14, 15, 12};
    exp_rlslp.non_terminals[15] = non_terminal<var_t, term_t>{17, 15, 9};
    exp_rlslp.non_terminals[16] = non_terminal<var_t, term_t>{16, 18, 7};
    exp_rlslp.blocks = 5;
...
TEST(pcomp_hash, 19162021) {
    ...
    rlslp.non_terminals[12] = non_terminal<var_t, term_t>{8, 12, 5};
    rlslp.non_terminals[13] = non_terminal<var_t, term_t>{3, 9, 3};
    rlslp.non_terminals[14] = non_terminal<var_t, term_t>{14, 15, 12};
    rlslp.non_terminals[15] = non_terminal<var_t, term_t>{17, 15, 9};
    rlslp.non_terminals[16] = non_terminal<var_t, term_t>{16, 18, 7};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[15] = non_terminal<var_t, term_t>{17, 15, 9};
    exp_rlslp.non_terminals[16] = non_terminal<var_t, term_t>{16, 18, 7};
    exp_rlslp.non_terminals[17] = non_terminal<var_t, term_t>{19, 16, 16};
    exp_rlslp.non_terminals[18] = non_terminal<var_t, term_t>{20, 21, 16};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
...
TEST(pcomp_hash, 2223) {
    ...
    rlslp.non_terminals[15] = non_terminal<var_t, term_t>{17, 15, 9};
    rlslp.non_terminals[16] = non_terminal<var_t, term_t>{16, 18, 7};
    rlslp.non_terminals[17] = non_terminal<var_t, term_t>{19, 16, 16};
    rlslp.non_terminals[18] = non_terminal<var_t, term_t>{20, 21, 16};
    rlslp.blocks = 5;
    bv_t bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false, false,
            false, false, false};
    recomp.pcomp(text, rlslp, bv);
    ...
    exp_rlslp.non_terminals[17] = non_terminal<var_t, term_t>{19, 16, 16};
    exp_rlslp.non_terminals[18] = non_terminal<var_t, term_t>{20, 21, 16};
    exp_rlslp.non_terminals[19] = non_terminal<var_t, term_t>{22, 23, 32};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
...
TEST(recomp_hash, recompression) {
    ...
    exp_rlslp.resize(20);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{2, 1, 2};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{20, 1, 4};
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{2, 3, 2};
    exp_rlslp.non_terminals[3] = non_terminal<var_t, term_t>{4, 1, 2};
    exp_rlslp.non_terminals[4] = non_terminal<var_t, term_t>{24, 6, 8};
    exp_rlslp.non_terminals[5] = non_terminal<var_t, term_t>{21, 7, 4};
    exp_rlslp.non_terminals[6] = non_terminal<var_t, term_t>{22, 8, 4};
    exp_rlslp.non_terminals[7] = non_terminal<var_t, term_t>{23, 8, 5};
    exp_rlslp.non_terminals[8] = non_terminal<var_t, term_t>{3, 5, 3};
    exp_rlslp.non_terminals[9] = non_terminal<var_t, term_t>{9, 10, 12};
    exp_rlslp.non_terminals[10] = non_terminal<var_t, term_t>{12, 10, 9};
    exp_rlslp.non_terminals[11] = non_terminal<var_t, term_t>{11, 13, 7};
    exp_rlslp.non_terminals[12] = non_terminal<var_t, term_t>{14, 11, 16};
    exp_rlslp.non_terminals[13] = non_terminal<var_t, term_t>{15, 16, 16};
    exp_rlslp.non_terminals[14] = non_terminal<var_t, term_t>{17, 18, 32};
    exp_rlslp.non_terminals[15] = non_terminal<var_t, term_t>{4, 3, 3};
    exp_rlslp.non_terminals[16] = non_terminal<var_t, term_t>{3, 2, 2};
    exp_rlslp.non_terminals[17] = non_terminal<var_t, term_t>{1, 2, 2};
    exp_rlslp.non_terminals[18] = non_terminal<var_t, term_t>{3, 3, 3};
...
TEST(recomp_hash, two_blocks) {
    ...
    exp_rlslp.root = 3;
    exp_rlslp.resize(3);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{4, 5, 16};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{2, 9, 9};
...
TEST(recomp_hash, three_blocks) {
    ...
    exp_rlslp.root = 4;
    exp_rlslp.resize(5);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{5, 6, 16};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{3, 7, 20};
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{2, 9, 9};
    exp_rlslp.non_terminals[3] = non_terminal<var_t, term_t>{1, 7, 7};
    exp_rlslp.non_terminals[4] = non_terminal<var_t, term_t>{2, 4, 4};
    exp_rlslp.blocks = 2;
    exp_rlslp.is_empty = false;
...
TEST(recomp_hash, four_blocks) {
    ...
    exp_rlslp.root = 5;
    exp_rlslp.resize(7);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{6, 7, 16};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{8, 9, 6};
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{3, 4, 22};
    ...
    exp_rlslp.non_terminals[6] = non_terminal<var_t, term_t>{0, 2, 2};
    exp_rlslp.blocks = 3;
    exp_rlslp.is_empty = false;
