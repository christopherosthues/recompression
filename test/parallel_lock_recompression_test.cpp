...
typedef parallel::parallel_lock_recompression<var_t>::text_t text_t;
typedef parallel::parallel_lock_recompression<var_t>::adj_list_t adj_list_t;
typedef parallel::parallel_lock_recompression<var_t>::partition_t partition_t;
typedef parallel::parallel_lock_recompression<var_t>::alphabet_t alphabet_t;
typedef parallel::parallel_lock_recompression<var_t>::bv_t bv_t;

TEST(parallel_lock_bcomp, no_block) {
    text_t text = {2, 1, 2, 1, 4, 1, 3, 2, 3, 1, 4, 1, 3, 4, 1, 3, 2, 3, 1, 4, 1, 3, 2, 1};
    rlslp<var_t> rlslp;
    parallel::parallel_lock_recompression<var_t> recomp;
    recomp.cores = 4;
