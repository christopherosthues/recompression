...
TEST(parallel_order_ls_pcomp, 212181623541741623541321) {
    ...
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{3, 3, 3};
    exp_rlslp.non_terminals[3] = non_terminal<var_t, term_t>{4, 3, 3};
    exp_rlslp.non_terminals[4] = non_terminal<var_t, term_t>{2, 3, 2};
    exp_rlslp.non_terminals[5] = non_terminal<var_t, term_t>{2, 1, 2};
...
TEST(parallel_order_ls_pcomp, 13126951171169511310) {
    ...
    rlslp.non_terminals[2] = non_terminal<var_t, term_t>{3, 3, 3};
    rlslp.non_terminals[3] = non_terminal<var_t, term_t>{4, 3, 3};
    rlslp.non_terminals[4] = non_terminal<var_t, term_t>{2, 3, 2};
    rlslp.non_terminals[5] = non_terminal<var_t, term_t>{2, 1, 2};
    rlslp.non_terminals[6] = non_terminal<var_t, term_t>{4, 1, 2};
    rlslp.non_terminals[7] = non_terminal<var_t, term_t>{8, 1, 4};
    rlslp.non_terminals[8] = non_terminal<var_t, term_t>{10, 2, 4};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[6] = non_terminal<var_t, term_t>{4, 1, 2};
    exp_rlslp.non_terminals[7] = non_terminal<var_t, term_t>{8, 1, 4};
    exp_rlslp.non_terminals[8] = non_terminal<var_t, term_t>{10, 2, 4};
    exp_rlslp.non_terminals[9] = non_terminal<var_t, term_t>{3, 10, 3};
    exp_rlslp.non_terminals[10] = non_terminal<var_t, term_t>{5, 11, 4};
    exp_rlslp.non_terminals[11] = non_terminal<var_t, term_t>{6, 9, 4};
...
TEST(parallel_order_ls_pcomp, 18161517161514) {
    ...
    rlslp.non_terminals[7] = non_terminal<var_t, term_t>{8, 1, 4};
    rlslp.non_terminals[8] = non_terminal<var_t, term_t>{10, 2, 4};
    rlslp.non_terminals[9] = non_terminal<var_t, term_t>{3, 10, 3};
    rlslp.non_terminals[10] = non_terminal<var_t, term_t>{5, 11, 4};
    rlslp.non_terminals[11] = non_terminal<var_t, term_t>{6, 9, 4};
    ...
    exp_rlslp.non_terminals[12] = non_terminal<var_t, term_t>{7, 11, 5};
    exp_rlslp.non_terminals[13] = non_terminal<var_t, term_t>{13, 12, 8};
    exp_rlslp.non_terminals[14] = non_terminal<var_t, term_t>{15, 17, 9};
    exp_rlslp.non_terminals[15] = non_terminal<var_t, term_t>{15, 14, 7};
...
TEST(parallel_order_ls_pcomp, 21191620) {
    ...
    rlslp.non_terminals[12] = non_terminal<var_t, term_t>{7, 11, 5};
    rlslp.non_terminals[13] = non_terminal<var_t, term_t>{13, 12, 8};
    rlslp.non_terminals[14] = non_terminal<var_t, term_t>{15, 17, 9};
    rlslp.non_terminals[15] = non_terminal<var_t, term_t>{15, 14, 7};
    ...
    exp_rlslp.non_terminals[15] = non_terminal<var_t, term_t>{15, 14, 7};
    exp_rlslp.non_terminals[16] = non_terminal<var_t, term_t>{18, 16, 12};
    exp_rlslp.non_terminals[17] = non_terminal<var_t, term_t>{16, 20, 11};
    exp_rlslp.non_terminals[18] = non_terminal<var_t, term_t>{21, 19, 21};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
...
TEST(parallel_order_ls_pcomp, 2322) {
    ...
    rlslp.non_terminals[15] = non_terminal<var_t, term_t>{15, 14, 7};
    rlslp.non_terminals[16] = non_terminal<var_t, term_t>{18, 16, 12};
    rlslp.non_terminals[17] = non_terminal<var_t, term_t>{16, 20, 11};
    rlslp.non_terminals[18] = non_terminal<var_t, term_t>{21, 19, 21};
    rlslp.blocks = 5;
    bv_t bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false, false,
            false, false, false};
    recomp.pcomp(text, rlslp, bv);
...
TEST(parallel_order_ls_recomp, recompression) {
    ...
    exp_rlslp.root = 19;
    exp_rlslp.resize(20);
    exp_rlslp.non_terminals[0] = non_terminal<var_t, term_t>{2, 3, 2};
    exp_rlslp.non_terminals[1] = non_terminal<var_t, term_t>{2, 1, 2};
    exp_rlslp.non_terminals[2] = non_terminal<var_t, term_t>{4, 1, 2};
    exp_rlslp.non_terminals[3] = non_terminal<var_t, term_t>{23, 1, 4};
    exp_rlslp.non_terminals[4] = non_terminal<var_t, term_t>{3, 6, 3};
    exp_rlslp.non_terminals[5] = non_terminal<var_t, term_t>{20, 7, 4};
    exp_rlslp.non_terminals[6] = non_terminal<var_t, term_t>{21, 5, 4};
    exp_rlslp.non_terminals[7] = non_terminal<var_t, term_t>{22, 7, 5};
    exp_rlslp.non_terminals[8] = non_terminal<var_t, term_t>{24, 8, 8};
    exp_rlslp.non_terminals[9] = non_terminal<var_t, term_t>{10, 12, 9};
    exp_rlslp.non_terminals[10] = non_terminal<var_t, term_t>{10, 9, 7};
    exp_rlslp.non_terminals[11] = non_terminal<var_t, term_t>{13, 11, 12};
    exp_rlslp.non_terminals[12] = non_terminal<var_t, term_t>{11, 15, 11};
    exp_rlslp.non_terminals[13] = non_terminal<var_t, term_t>{16, 14, 21};
    ...
    exp_rlslp.non_terminals[19] = non_terminal<var_t, term_t>{6, 2, 4};
    exp_rlslp.blocks = 15;
    exp_rlslp.is_empty = false;
