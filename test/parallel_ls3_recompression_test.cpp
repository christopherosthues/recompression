...
typedef parallel::parallel_ls3_recompression<var_t>::text_t text_t;
typedef parallel::parallel_ls3_recompression<var_t>::adj_t adj_t;
typedef parallel::parallel_ls3_recompression<var_t>::adj_list_t adj_list_t;
typedef parallel::parallel_ls3_recompression<var_t>::partition_t partition_t;
typedef parallel::parallel_ls3_recompression<var_t>::alphabet_t alphabet_t;
typedef parallel::parallel_ls3_recompression<var_t>::bv_t bv_t;
...
TEST(parallel_ls3_bcomp, no_block) {
    ...
    rlslp<var_t> rlslp;
    parallel::parallel_ls3_recompression<var_t> recomp;
    recomp.cores = 4;
