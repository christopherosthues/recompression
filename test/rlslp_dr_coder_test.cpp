...
TEST(rlslp_dr_coder, short_block) {
    recomp::rlslp<var_t, term_t> rlslp;
    text_t text = {112, 112};
    parallel::parallel_recompression<var_t, term_t> recomp;
...
TEST(rlslp_dr_coder, short_block3) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, recompression) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, two_blocks) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, three_blocks) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, four_blocks) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, repeated_pair) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_dr_coder, repeated_pair_same_occ) {
    recomp::rlslp<var_t, term_t> rlslp;
