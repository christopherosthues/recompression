...
TEST(rlslp_coder, recompression) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_coder, repeated_pair) {
    recomp::rlslp<var_t, term_t> rlslp;
...
TEST(rlslp_coder, repeated_pair_same_occ) {
    recomp::rlslp<var_t, term_t> rlslp;
