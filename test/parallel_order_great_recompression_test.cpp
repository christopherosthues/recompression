...
typedef parallel::recompression_order_gr<var_t>::text_t text_t;
typedef parallel::recompression_order_gr<var_t>::adj_list_t adj_list_t;
typedef parallel::recompression_order_gr<var_t>::partition_t partition_t;
typedef parallel::recompression_order_gr<var_t>::alphabet_t alphabet_t;
typedef parallel::recompression_order_gr<var_t>::bv_t bv_t;
...
TEST(parallel_order_gr_bcomp, no_block) {
    ...
    rlslp<var_t> rlslp;
    parallel::recompression_order_gr<var_t> recomp;
    recomp.cores = 4;
...
TEST(parallel_order_gr_pcomp, 212181623541741623541321) {
    ...
    exp_rlslp.non_terminals[5] = non_terminal<var_t>{4, 1, 2};
    exp_rlslp.non_terminals[6] = non_terminal<var_t>{8, 1, 4};
    exp_rlslp.non_terminals[7] = non_terminal<var_t>{2, 3, 2};
    exp_rlslp.blocks = 4;
...
TEST(parallel_order_gr_pcomp, 131161251071061251039) {
    ...
    rlslp.non_terminals[5] = non_terminal<var_t>{4, 1, 2};
    rlslp.non_terminals[6] = non_terminal<var_t>{8, 1, 4};
    rlslp.non_terminals[7] = non_terminal<var_t>{2, 3, 2};
    ...
    exp_rlslp.non_terminals[9] = non_terminal<var_t>{13, 11, 8};
    exp_rlslp.non_terminals[10] = non_terminal<var_t>{3, 9, 3};
    exp_rlslp.non_terminals[11] = non_terminal<var_t>{5, 10, 4};
    exp_rlslp.non_terminals[12] = non_terminal<var_t>{7, 10, 5};
    exp_rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
...
TEST(parallel_order_gr_pcomp, 14181617181615) {
    ...
    rlslp.non_terminals[7] = non_terminal<var_t>{2, 3, 2};
    rlslp.non_terminals[8] = non_terminal<var_t>{9, 2, 4};
    rlslp.non_terminals[9] = non_terminal<var_t>{13, 11, 8};
    rlslp.non_terminals[10] = non_terminal<var_t>{3, 9, 3};
    rlslp.non_terminals[11] = non_terminal<var_t>{5, 10, 4};
    rlslp.non_terminals[12] = non_terminal<var_t>{7, 10, 5};
    rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[12] = non_terminal<var_t>{7, 10, 5};
    exp_rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
    exp_rlslp.non_terminals[14] = non_terminal<var_t>{18, 16, 8};
    exp_rlslp.blocks = 5;
...
TEST(parallel_order_gr_pcomp, 1419171915) {
    ...
    rlslp.non_terminals[12] = non_terminal<var_t>{7, 10, 5};
    rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
    rlslp.non_terminals[14] = non_terminal<var_t>{18, 16, 8};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
    exp_rlslp.non_terminals[14] = non_terminal<var_t>{18, 16, 8};
    exp_rlslp.non_terminals[15] = non_terminal<var_t>{14, 19, 16};
    exp_rlslp.non_terminals[16] = non_terminal<var_t>{17, 19, 13};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
                false, false};
...
TEST(parallel_order_gr_pcomp, 202115) {
    ...
    rlslp.non_terminals[13] = non_terminal<var_t>{6, 12, 4};
    rlslp.non_terminals[14] = non_terminal<var_t>{18, 16, 8};
    rlslp.non_terminals[15] = non_terminal<var_t>{14, 19, 16};
    rlslp.non_terminals[16] = non_terminal<var_t>{17, 19, 13};
    rlslp.blocks = 5;
    ...
    exp_rlslp.non_terminals[15] = non_terminal<var_t>{14, 19, 16};
    exp_rlslp.non_terminals[16] = non_terminal<var_t>{17, 19, 13};
    exp_rlslp.non_terminals[17] = non_terminal<var_t>{20, 21, 29};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
                false, false, false};
...
TEST(parallel_order_gr_pcomp, 2215) {
    ...
    rlslp.non_terminals[15] = non_terminal<var_t>{14, 19, 16};
    rlslp.non_terminals[16] = non_terminal<var_t>{17, 19, 13};
    rlslp.non_terminals[17] = non_terminal<var_t>{20, 21, 29};
    rlslp.blocks = 5;
    bv_t bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false, false,
            false, false};
    recomp.pcomp(text, rlslp, bv);
    ...
    exp_rlslp.non_terminals[16] = non_terminal<var_t>{17, 19, 13};
    exp_rlslp.non_terminals[17] = non_terminal<var_t>{20, 21, 29};
    exp_rlslp.non_terminals[18] = non_terminal<var_t>{22, 15, 32};
    exp_rlslp.blocks = 5;
    bv_t exp_bv = {true, true, true, true, false, false, false, false, true, false, false, false, false, false, false,
...
TEST(parallel_order_gr_recomp, recompression) {
    ...
    exp_rlslp.resize(19, 4);
    exp_rlslp.non_terminals[0] = non_terminal<var_t>{2, 1, 2};
    exp_rlslp.non_terminals[1] = non_terminal<var_t>{4, 1, 2};
    exp_rlslp.non_terminals[2] = non_terminal<var_t>{22, 1, 4};
    exp_rlslp.non_terminals[3] = non_terminal<var_t>{2, 3, 2};
    exp_rlslp.non_terminals[4] = non_terminal<var_t>{23, 7, 8};
    exp_rlslp.non_terminals[5] = non_terminal<var_t>{3, 5, 3};
    exp_rlslp.non_terminals[6] = non_terminal<var_t>{19, 6, 4};
    exp_rlslp.non_terminals[7] = non_terminal<var_t>{21, 6, 5};
    exp_rlslp.non_terminals[8] = non_terminal<var_t>{20, 8, 4};
    exp_rlslp.non_terminals[9] = non_terminal<var_t>{13, 11, 8};
    exp_rlslp.non_terminals[10] = non_terminal<var_t>{9, 14, 16};
    exp_rlslp.non_terminals[11] = non_terminal<var_t>{12, 14, 13};
    exp_rlslp.non_terminals[12] = non_terminal<var_t>{15, 16, 29};
    exp_rlslp.non_terminals[13] = non_terminal<var_t>{17, 10, 32};
    exp_rlslp.non_terminals[14] = non_terminal<var_t>{1, 2, 2};
    exp_rlslp.non_terminals[15] = non_terminal<var_t>{3, 2, 2};
    exp_rlslp.non_terminals[16] = non_terminal<var_t>{3, 3, 3};
    exp_rlslp.non_terminals[17] = non_terminal<var_t>{4, 3, 3};
    exp_rlslp.non_terminals[18] = non_terminal<var_t>{5, 2, 4};
    exp_rlslp.blocks = 14;
    exp_rlslp.is_empty = false;
