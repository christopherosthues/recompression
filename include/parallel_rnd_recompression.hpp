...
//                std::cout << std::endl;
//                for (size_t j = 0; j < alpha_counts.size(); ++j) {
//                    std::cout << alpha_counts[j] << ", ";
//                }
//                std::cout << std::endl;
//                for (size_t j = 0; j < alpha_bounds.size(); ++j) {
//                    std::cout << alpha_bounds[j] << ", ";
//                }
//                std::cout << std::endl << "bounds and count" << std::endl;
            }
