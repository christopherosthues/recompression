...
class parallel_ls5_recompression : public parallel_rnd_recompression<variable_t, terminal_count_t> {
 public:
    ...
    inline parallel_ls5_recompression() {
        this->name = "parallel_ls5";
    }

    inline parallel_ls5_recompression(std::string& dataset) : parallel_rnd_recompression<variable_t, terminal_count_t>(dataset) {
        this->name = "parallel_ls5";
    }
