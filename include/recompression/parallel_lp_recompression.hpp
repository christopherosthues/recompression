...
class parallel_lp_recompression : public recompression<variable_t, terminal_count_t> {
 public:
    ...
    inline parallel_lp_recompression(std::string& dataset) : recomp::recompression<variable_t, terminal_count_t>(dataset) {
        this->name = "parallel_lp";
    }
