...
class parallel_grz_recompression : public parallel_rnd_recompression<variable_t, terminal_count_t> {
 public:
    ...
    inline parallel_grz_recompression(std::string& dataset) : parallel_rnd_recompression<variable_t, terminal_count_t>(dataset) {
        this->name = "parallel_grz";
    }
