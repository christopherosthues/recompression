...
class full_parallel_recompression : public parallel_recompression<variable_t, terminal_count_t> {
 public:
    ...
    inline full_parallel_recompression(std::string& dataset) : parallel_recompression<variable_t, terminal_count_t>(dataset) {
        this->name = "full_parallel";
    }
