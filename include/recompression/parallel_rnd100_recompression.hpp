...
class parallel_rnd100_recompression : public parallel_lp_recompression<variable_t> {
 public:
    ...
    inline parallel_rnd100_recompression() {
        this->name = "parallel_rnd100";
    }

    inline parallel_rnd100_recompression(std::string& dataset) : parallel_lp_recompression<variable_t>(dataset) {
        this->name = "parallel_rnd100";
    }
